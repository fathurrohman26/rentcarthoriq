...
define("WPDISCUZ_DIR_URL", rtrim(rct_plugin_dir_url(__FILE__), '/\\'));
...
class WpdiscuzCore implements WpDiscuzConstants //phpcs:ignore
{
    /**
        ...
        if ($uniqueId && $postId) {
            ...
            if ($this->form->isUserCanSeeComments($currentUser, $postId) && $this->form->isUserCanComment($currentUser, $postId)) {
                ...
                if ($wooExists && !$replyForWoo) {
                    $isInSameContainer = "0";
                } elseif ($commentDepth > $this->options->wp["threadCommentsDepth"]) {
                    $commentDepth      = $this->options->wp["threadCommentsDepth"];
                    $isInSameContainer = "0";
                } elseif (!$this->options->wp["threadComments"]) {
                    $isInSameContainer = "0";
                }
...
//                    $this->form->saveCommentMeta($new_comment_id);
                    ...
                    } elseif (!$isAnonymous && $notificationType) {
...
//                  remove_filter( 'wp_is_comment_flood', 'wp_check_comment_flood', 10);
                    ...
                    if ($trimmedContent !== $comment->comment_content) {
                        ...
                        if (class_exists("Akismet") && method_exists('Akismet', 'auto_check_comment')) {
                            ...
                            } elseif ($commentarr["akismet_result"] === "true") {
        ...
        if ($commentId && $postId && $comment && $comment->comment_post_ID == $postId) {
            ...
            if ($this->form->isUserCanSeeComments($commentListArgs["current_user"], $postId)) {
                ...
                if ($comment->comment_approved === "0") {
                    if ($commentListArgs["high_level_user"]) {
                    ...
                    } elseif (!empty($this->commentsArgs["include_unapproved"])) {
                        ...
                        } elseif ($comment->comment_author_email === $this->commentsArgs["include_unapproved"][0]) {
                            $showUnapprovedComment = true;
                        }
                    }
                }
                if ($comment->comment_approved === "1" || $showUnapprovedComment) {
                    ...
                    } elseif ($parentComment = $this->helperOptimization->getCommentRoot($commentId, $commentStatusIn, $includeUnapproved)) {
                        $args = [
                            "format"  => "flat",
    ...
    public function _getWPComments(&$commentListArgs, &$commentData)
    {
        if ($this->options->wp["isPaginate"]) {// PAGINATION
            ...
            } elseif ($this->options->wp["defaultCommentsPage"] === "oldest") {
            ...
            if ($commentList && is_array($commentList)) {
                ...
                if (apply_filters("wpdiscuz_show_comments_left", false)) {
                    ...
                    $commentData["comments_left_text"]    = apply_filters(
    ...
    public function commentsClauses($args)
    {
        ...
        if (isset($this->commentsArgs["caller"]) && $this->commentsArgs["caller"] === "wpdiscuz" && !$this->options->wp["isPaginate"]) {
            ...
            } elseif ($this->commentsArgs["last_parent_id"] && empty($this->commentsArgs["sticky"])) {
    ...
    public function backendFiles()
    {
        ...
        wp_register_style("wpdiscuz-font-awesome", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/font-awesome-5.13.0/css/fontawesome-all.min.css"), null, $this->version);
        ...
        if ((isset($_GET["page"]) && in_array($_GET["page"], $wpdiscuzPages) && in_array($pagenow, $wpdiscuzWpPages)) || ($typenow === "wpdiscuz_form") || ($pagenow === self::PAGE_COMMENTS)) {
            ...
            wp_register_style("wmu-colorbox-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/colorbox/colorbox.css"));
            wp_enqueue_style("wmu-colorbox-css");
            wp_register_script("wmu-colorbox-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/colorbox/jquery.colorbox.min.js"), ["jquery"]);
            wp_enqueue_script("wmu-colorbox-js");

            wp_register_style("wpdiscuz-mu-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-mu-backend.css"));
            wp_enqueue_style("wpdiscuz-mu-css");
            wp_register_script("wpdiscuz-mu-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-mu-backend.js"), ["jquery"], $this->version, true);
            ...
            wp_register_style("wpdiscuz-options-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-options.css"), null, $this->version);
            wp_enqueue_style("wpdiscuz-options-css");
            wp_register_script("wpdiscuz-options-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-options.js"), ["jquery"], $this->version);
            wp_enqueue_script("wpdiscuz-options-js");
            wp_localize_script("wpdiscuz-options-js", "wpdiscuzObj", $args);
            wp_enqueue_script("thickbox");
            wp_register_script("wpdiscuz-contenthover", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/contenthover/jquery.contenthover.min.js"), ["jquery"], $this->version, true);
            wp_enqueue_script("wpdiscuz-contenthover");

            if (isset($_GET["page"])) {
                if ($_GET["page"] === self::PAGE_WPDISCUZ) {
                    wp_register_style("wpdiscuz-easy-responsive-tabs-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/easy-responsive-tabs/css/easy-responsive-tabs.min.css"), null, $this->version);
                    wp_enqueue_style("wpdiscuz-easy-responsive-tabs-css");
                    wp_register_script("wpdiscuz-easy-responsive-tabs-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/easy-responsive-tabs/js/easy-responsive-tabs.js"), ["jquery"], $this->version, true);
                    wp_enqueue_script("wpdiscuz-easy-responsive-tabs-js");
                    wp_register_script("wpdiscuz-jquery-cookie", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/wpdccjs/wpdcc.js"), ["jquery"], $this->version, true);
                    wp_enqueue_script("wpdiscuz-jquery-cookie");
                    wp_register_script("wpdiscuz-chart-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/chart/chart.min.js"), [], $this->version, true);
                    wp_enqueue_script("wpdiscuz-chart-js");
                } elseif ($_GET["page"] === self::PAGE_PHRASES) {
                    wp_register_style("wpdiscuz-easy-responsive-tabs-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/easy-responsive-tabs/css/easy-responsive-tabs.min.css"), null, $this->version);
                    wp_enqueue_style("wpdiscuz-easy-responsive-tabs-css");
                    wp_register_script("wpdiscuz-easy-responsive-tabs-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/easy-responsive-tabs/js/easy-responsive-tabs.js"), ["jquery"], $this->version, true);
                    wp_enqueue_script("wpdiscuz-easy-responsive-tabs-js");
        ...
        } elseif ($pagenow === "comment.php") {
            wp_register_style("wpdiscuz-options-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-options.css"), null, $this->version);
            wp_enqueue_style("wpdiscuz-options-css");
            wp_enqueue_style("wpdiscuz-font-awesome");
        }
        if (version_compare($wp_version, "4.2.0", ">=")) {
            wp_register_script("wpdiscuz-addon-notes", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-notes.js"), ["jquery"], $this->version, true);
        ...
        if (!get_option(self::OPTION_SLUG_DEACTIVATION) && (strpos($this->requestUri, "/plugins.php") !== false)) {
            ...
            wp_register_style("wpdiscuz-lity-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/lity/lity.css"), null, $this->version);
            wp_enqueue_style("wpdiscuz-lity-css");
            wp_register_script("wpdiscuz-lity-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/lity/lity.js"), ["jquery"], $this->version);
            wp_enqueue_script("wpdiscuz-lity-js");
            wp_register_style("wpdiscuz-deactivation-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-deactivation.css"));
            wp_enqueue_style("wpdiscuz-deactivation-css");
            wp_register_script("wpdiscuz-deactivation-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-deactivation.js"), ["jquery"], $this->version);
        ...
        wp_localize_script(self::WPDISCUZ_FEEDBACK_SHORTCODE . "-shortcode-js", "wpdObject", [
            ...
            "image"            => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/shortcode.png"),
    ...
    public function frontendFiles()
    {
        ...
        wp_register_style("wpdiscuz-font-awesome", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/font-awesome-5.13.0/css/fontawesome-all.min.css"), null, $this->version);
        wp_register_style("wpdiscuz-ratings", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-ratings$suf.css"), null, $this->version);
        wp_register_style("wpdiscuz-ratings-rtl", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-ratings-rtl$suf.css"), null, $this->version);
        ...
        if ($this->isWpdiscuzLoaded) {
            ...
            $this->wpdiscuzOptionsJs["customAjaxUrl"]       = rct_plugins_url(WPDISCUZ_DIR_NAME . "/utils/ajax/wpdiscuz-ajax.php");
            ...
            } elseif ($this->options->thread_styles["theme"] === "wpd-minimal") {
            ...
            if ($this->options->thread_styles["enableFontAwesome"]) {
                if ($this->form->hasIcon) {
                    ...
                    wp_register_style("wpdiscuz-fa", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/font-awesome-5.13.0/css/fa.min.css"), null, $this->version);
            ...
            if ($this->options->general["loadComboVersion"]) {
                ...
                wp_register_style("wpdiscuz-combo-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-combo$combo_css.min.css"));
                wp_enqueue_style("wpdiscuz-combo-css");
                wp_register_script("wpdiscuz-combo-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-combo$combo_js.min.js"), ["jquery"], $this->version, true);
                ...
                wp_register_script("wpdiscuz-cookie-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/wpdccjs/wpdcc.js"), ["jquery"], $this->version, true);
                wp_enqueue_script("wpdiscuz-cookie-js");
                //
                if ($loadQuill) {
                    wp_register_style("quill-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/quill/quill.snow$suf.css"), null, "1.3.6");
                    wp_enqueue_style("quill-css");
                    wp_register_script("quill", rct_plugins_url("/assets/third-party/quill/quill$suf.js", __FILE__), ["wpdiscuz-cookie-js"], "1.3.6", true);
                    wp_enqueue_script("quill");
                    wp_add_inline_script("quill", $this->options->editorOptions(), "before");
                    wp_register_script("wpd-editor", rct_plugins_url("/assets/js/wpd-editor$suf.js", __FILE__), ["quill"], "1.3.6", true);
                    wp_enqueue_script("wpd-editor");
                }
                wp_register_script("autogrowtextarea-js", rct_plugins_url("/assets/third-party/autogrow/jquery.autogrowtextarea.min.js", __FILE__), ["jquery"], "1.3.6", true);
                wp_enqueue_script("autogrowtextarea-js");
                wp_register_script("wpdiscuz-ajax-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz$suf.js"), [$loadQuill ? "wpd-editor" : "jquery"], $this->version, true);
                ...
                if ($this->options->content["wmuIsEnabled"]) {
                    ...
                    if ($this->options->content["wmuIsLightbox"]) {
                        wp_register_style("wmu-colorbox-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/colorbox/colorbox$suf.css"));
                        wp_enqueue_style("wmu-colorbox-css");
                        wp_register_script("wmu-colorbox-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/colorbox/jquery.colorbox$suf.js"), ["jquery"], $this->version, true);
                        wp_enqueue_script("wmu-colorbox-js");
                    }
                    wp_register_style("wpdiscuz-mu-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-mu-frontend$suf.css"));
                    wp_enqueue_style("wpdiscuz-mu-css");
                    wp_register_script("wpdiscuz-mu-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-mu-frontend$suf.js"), ["wpdiscuz-ajax-js"], $this->version, true);
                    wp_enqueue_script("wpdiscuz-mu-js");
                }
                if ($this->options->login["showActivityTab"] || $this->options->login["showSubscriptionsTab"] || $this->options->login["showFollowsTab"] || apply_filters("wpdiscuz_enable_content_modal", false)) {
                    wp_register_style("wpdiscuz-user-content-css", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-user-content$suf.css"), null, $this->version);
                    wp_enqueue_style("wpdiscuz-user-content-css");
                    wp_register_script("wpdiscuz-lity-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/third-party/lity/lity$suf.js"), ["jquery"], $this->version, true);
                    wp_enqueue_script("wpdiscuz-lity-js");
                    wp_register_script("wpdiscuz-user-content-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-user-content$suf.js"), ["wpdiscuz-lity-js"], $this->version, true);
            ...
            if (!$loadQuill && $this->options->form["enableQuickTags"]) {
                ...
                wp_register_script("wpdiscuz-quicktags", rct_plugins_url("/assets/third-party/quicktags/wpdiscuz-quictags.js", __FILE__), [$this->options->general["loadComboVersion"] ? "wpdiscuz-combo-js" : "wpdiscuz-ajax-js"], $this->version, true);
    ...
    {
        wp_register_script("wpdiscuz-for-elementor", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-shortcode-for-elementor.js"), ["jquery"], $this->version, true);
    ...
    {
        wp_register_style("wpdiscuz-for-elementor", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/css/wpdiscuz-shortcode-for-elementor.css"));
    ...
    public function getCommentListArgs($postId)
    {
        ...
        $args = [
            ...
            "avatar_trackback"             => apply_filters("wpdiscuz_avatar_trackback", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/trackback.png")),
    ...
    public function mceExternalPlugin($plugin_array)
    {
        global $post;
        if (!empty($post->ID) && comments_open($post->ID) && apply_filters("wpdiscuz_enable_feedback_shortcode_button", true) && ($form = $this->wpdiscuzForm->getForm($post->ID)) && $form->getFormID()) {
            $plugin_array["wpDiscuz"] = esc_url_raw(rct_plugins_url("assets/js/wpdiscuz-shortcode-tinymce.js", __FILE__));
        }
    ...
    public function gutenbergButton()
    {
        global $post;
        if (!empty($post->ID) && comments_open($post->ID) && apply_filters("wpdiscuz_enable_feedback_shortcode_button", true) && ($form = $this->wpdiscuzForm->getForm($post->ID)) && $form->getFormID()) {
            wp_register_script(self::WPDISCUZ_FEEDBACK_SHORTCODE . "-shortcode-gutenberg-js", rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/js/wpdiscuz-shortcode-gutenberg.js"), [
                "wp-blocks",
                "wp-editor",
                "wp-components"
            ]);
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="width: 50%;">
                                ...
                                <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/inline-feedback-closed.png")) ?>"
                            ...
                            <td style="width: 50%">
                                ...
                                <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/inline-feedback-opened.png")) ?>"
                                     class="wpd-fbs-screen">
                            </td>
                        </tr>
                    </table>
    ...
    public function validateRecaptcha($commentdata)
    {
        if (!current_user_can("moderate_comments")) {
            ...
            if (!$postId) {
                ...
                if (!empty($post->ID)) {
                    $postId = $post->ID;
                } elseif (!empty($commentdata["comment_post_ID"])) {
