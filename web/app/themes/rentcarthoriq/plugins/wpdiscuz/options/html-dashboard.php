...
<div id="wpd-dash" class="wrap wpd-dash">
    ...
    <div class="wpd-dash-head">
        ...
        <div class="wpd-dash-head-right">
            <img src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/wpdiscuz-7-logo.png"); ?>"/>
        ...
        <div class="resp-tabs-container wpdiscuz-news-options">
            <div class="wpd-tab-container">
                <img class="wpd-news-icon"
                     src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/icon-feedback.png")); ?>">
                ...
                <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/feedback-form.png")); ?>"
            ...
            <div class="wpd-tab-container">
                <img class="wpd-news-icon"
                     src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/icon-bubble.png")); ?>"
                     style="width: 90px;">
                ...
                <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/bubble-new-comment-info.png")); ?>"
                ...
                <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/bubble-invite-to-comment.png")); ?>"
            ...
            <div class="wpd-tab-container">
                <img class="wpd-news-icon"
                     src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/icon-layouts.png")); ?>"
            ...
            <div class="wpd-tab-container">
                <img class="wpd-news-icon"
                     src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/icon-social.png")); ?>"
                ...
                <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/social-networks-shadow.png")); ?>"
                     style="float: right; width: 65%; max-width: 520px; padding: 0px 14px; margin-bottom: -20px; position: relative; z-index: 10;">
                <div class="wpd-clear"></div>
                <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/wpDiscuz-Social-Network-icons-on-user-avatars.png")); ?>"
                     style="float: left;width:75%; max-width: 580px; padding: 0px 14px;">
                <div class="wpd-clear"></div>
            </div>
            <div class="wpd-tab-container">
                <img class="wpd-news-icon"
                     src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/icon-rating.png")); ?>"
    ...
    <div class="wpd-overview">
        ...
        <div class="wpd-stat-brief">
            <div class="wpd-stat-box wpd-box wpd-stat-brief-top">
                <div class="wpd-stat-cell">
                    <div class="wpd-cell-icon"><img
                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/icon-comment.png")); ?>"
                                width="30"></div>
                ...
                <div class="wpd-stat-cell">
                    <div class="wpd-cell-icon"><img
                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/icon-comment-inlinepng.png")); ?>"
                                width="36"></div>
                    <div class="wpd-cell-text"><span
                ...
                <div class="wpd-stat-cell">
                    <div class="wpd-cell-icon"><img
                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/icon-threads.png")); ?>">
                    </div>
                    <div class="wpd-cell-text"><span
                ...
                <div class="wpd-stat-cell">
                    <div class="wpd-cell-icon"><img
                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/icon-replies.png")); ?>"
                                width="30"></div>
                    <div class="wpd-cell-text"><span
            ...
            <div class="wpd-stat-box wpd-box wpd-stat-brief-bottom">
                <div class="wpd-stat-cell">
                    <div class="wpd-cell-icon"><img
                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/icon-users.png")); ?>"
                                width="24"></div>
                ...
                <div class="wpd-stat-cell">
                    <div class="wpd-cell-icon"><img
                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/icon-guests.png")); ?>"
                                width="24"></div>
                    <div class="wpd-cell-text"><span
