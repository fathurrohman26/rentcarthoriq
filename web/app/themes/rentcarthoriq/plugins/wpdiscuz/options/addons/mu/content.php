        ...
        <table class="widefat wpdiscuz-mu" style="margin-top:10px; border:none; width:100%; opacity: 0.6">
            ...
            <tr scope="row">
                ...
                <td><input type="checkbox" checked='checked' value="1" name="" id="wmuIsImagesAllowed"/> &nbsp; <img
                            src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/options/addons/images/image.png") ?>"/>
                </td>
            </tr>
            <tr scope="row">
                ...
                <td><input type="checkbox" checked='checked' value="1" name="" id="wmuIsVideosAllowed"/> &nbsp; <img
                            src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/options/addons/images/video.png") ?>"/>
                </td>
            </tr>
            <tr scope="row">
                <th>
                ...
                <td><input type="checkbox" checked='checked' value="1" name="" id="wmuIsFilesAllowed"/> &nbsp; <img
                            src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/options/addons/images/file.png") ?>"/>
                </td>
            </tr>
            <tr scope="row">
                <th>
                ...
                <td><input type="checkbox" checked='checked' value="1" name="" id="wmuIsEmbed"/> &nbsp;&nbsp; <img
                            src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/options/addons/images/html5-youtub-player.png") ?>"
            ...
            <tr scope="row" class="tr-wmuIsEmbedContent">
                ...
                <td><input type="checkbox" value="1" name="" id="wmuIsEmbedContent"/> &nbsp;&nbsp; <img
                            src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/options/addons/images/embedded-content.png") ?>"
            ...
            <tr scope="row">
                ...
                <td><input type="checkbox" checked='checked' value="1" name="" id="wmuIsHtml5Video"/> &nbsp; <img
                            src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/options/addons/images/html5-video-player.png") ?>"
            ...
            <tr scope="row">
                ...
                <td><input type="checkbox" checked='checked' value="1" name="" id="wmuIsHtml5Audio"/> &nbsp; <img
                            src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/options/addons/images/html5-audio-player.png") ?>"
