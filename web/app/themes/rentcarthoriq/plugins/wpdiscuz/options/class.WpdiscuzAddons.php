    ...
    private function initAddons()
    {
        $this->addons = [
            "bundle" => [
                ...
                "class" => "Bundle",
                "title" => "Addons Bundle",
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/bundle/header.png"),
            ...
            "notifications" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/notifications/header.png"),
            ...
            "buddypress" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/buddypress/header.png"),
            ...
            "voice" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/voice/header.png"),
            ...
            "tenor" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/tenor/header.png"),
            ...
            "giphy" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/giphy/header.png"),
            ...
            "uploader" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/uploader/header.png"),
            ...
            "embeds" => [
                ...
                "title" => "Embeds",
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/embeds/header.png"),
            ...
            "syntax" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/syntax/header.png"),
            ...
            "frontend-moderation" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/frontend-moderation/header.png"),
            ...
            "emoticons" => [
                ...
                "class" => "wpDiscuzSmile",
                "title" => "Emoticons",
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/emoticons/header.png"),
            ...
            "recaptcha" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/recaptcha/header.png"),
            ...
            "author-info" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/author-info/header.png"),
            ...
            "report-flagging" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/report/header.png"),
            ...
            "online-users" => [
                ...
                "title" => "Online Users",
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/online-users/header.png"),
            ...
            "private" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/private/header.png"),
            ...
            "subscriptions" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/subscriptions/header.png"),
            ...
            "ads-manager" => [
                ...
                "title" => "Ads Manager",
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/ads-manager/header.png"),
            ...
            "user-mention" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/user-mention/header.png"),
            ...
            "likers" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/likers/header.png"),
            ...
            "search" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/search/header.png"),
            ...
            "widgets" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/widgets/header.png"),
            ...
            "mycred" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/mycred/header.png"),
...
//      }
    ...
    {
        if (
            (!empty($_GET["page"]) && in_array($_GET["page"], [
                    self::PAGE_WPDISCUZ,
                    self::PAGE_SETTINGS,
                    self::PAGE_PHRASES,
                    self::PAGE_TOOLS,
            ...
            if (
                $lastHash !== $currentHash && (!in_array("BuddyPress Integration", $lastHashArray) || !in_array("Tenor GIFs Integration", $lastHashArray) || !in_array("Voice Commenting", $lastHashArray) || !in_array("GIPHY Integration", $lastHashArray) || !in_array("User Notifications", $lastHashArray))
            ) {
                ?>
                <div class="updated notice wpdiscuz_addon_note is-dismissible" style="margin-top:10px;">
                    ...
                    <div style="font-size:14px;">
                        ...
                        <!--                                <img src="-->
                        <?php //echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/buddypress/header.png");                          ?><!--" style="height:50px; width:auto; vertical-align:middle; margin:0px 10px; text-decoration:none; float: left;"/>-->
                        ...
                        <?php if (!in_array("User Notifications", $lastHashArray)) : ?>
                            <div style="display:inline-block; min-width:27%; padding-right:10px; margin-bottom:10px;">
                                <img src="<?php echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/notifications/header.png"); ?>"
                        ...
                        <!--                            <div style="display:inline-block; min-width:27%; padding-right:10px; margin-bottom:10px;">-->
                        <!--                                <img src="-->
                        <?php //echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/giphy/header.png");                           ?><!--" style="height:50px; width:auto; vertical-align:middle; margin:0px 10px; text-decoration:none; float: left;"/>-->
                        ...
                        <!--                            <div style="display:inline-block; min-width:27%; padding-right:10px; margin-bottom:10px;">-->
                        <!--                                <img src="-->
                        <?php //echo rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/tenor/header.png");                           ?><!--" style="height:50px; width:auto; vertical-align:middle; margin:0px 10px; text-decoration:none; float: left;"/>-->
    ...
    private function initTips()
    {
        $this->tips = [
            "custom-form" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/tips/custom-form.png"),
            ...
            "translate" => [
                ...
                "thumb" => rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/addons/translate/header.png"),
