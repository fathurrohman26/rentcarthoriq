...
<div class="wpd-opt-row" data-wpd-opt="bubbleShowNewCommentMessage">
    <div class="wpd-opt-name">
        ...
        <div style="width: 76%; margin-top: 5px;"><img
                    src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/bubble-new-comment-info.png")); ?>"
                    style="width: 100%;"/></div>
...
<div class="wpd-opt-row" data-wpd-opt="bubbleHintTimeout">
    <div class="wpd-opt-name">
        ...
        <div style="width: 77%; margin-top: 5px;"><img
                    src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/bubble-invite-to-comment.png")); ?>"
                    style="width: 100%"/></div>
