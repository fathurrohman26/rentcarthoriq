...
<div class="wpd-opt-row">
    <div class="wpd-opt-intro">
        <img class="wpd-opt-img"
             src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/" . $setting["icon"])); ?>"
...
<div class="wpd-social-label wpd-facebook" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/fb-m.png")); ?>"
...
<div class="wpd-social-label wpd-twitter" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/x-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    X
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-google" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/g-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Google
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-telegram" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/telegram.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Telegram
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-disqus" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/dq-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Disqus
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-wordpress" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/wp-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    WordPress.com
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-instagram" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/ig-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Instagram
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-linkedin" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/in-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    LinkedIn
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-wapp" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/wapp-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    WhatsApp
</div>
...
<div class="wpd-social-label wpd-yandex" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/ya-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Yandex
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-vk" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/vk-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    VK
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-mailru" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/mr-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Mail.ru
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-ok" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/ok-m.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    OK
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-wechat" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/wechat.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    WeChat
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-weibo" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/weibo.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Sina Weibo
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-qq" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/qq.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Tencent QQ
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
...
<div class="wpd-social-label wpd-baidu" style="padding: 25px 0px 10px 0px;">
    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/social-icons/baidu.png")); ?>"
         style="vertical-align:bottom; height: 24px; margin-bottom: -2px; position: relative; border-radius: 50%;">&nbsp;
    Baidu
</div>
<p style="font-size: 14px; font-style: italic; margin-top: 5px;">
