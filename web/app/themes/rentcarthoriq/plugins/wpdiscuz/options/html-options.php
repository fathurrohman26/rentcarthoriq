...
<div id="wpd-setbox" class="wrap wpd-dash">
    ...
    <div class="wpd-setbox-head">
        <div class="wpd-head-logo">
            <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/wpdiscuz-7-logo.png")); ?>"/>
        </div>
                ...
                <form method="post"
                    ...
                    <div class="wpd-wizard-body">
                        ...
                        if ($wizard === 1) {
                            ...
                            } elseif (is_dir(get_template_directory() . "/wpdiscuz")) {
                            ...
                            if ($customizedDir && count(scandir($customizedDir)) > 2) {
                                ...
                                <div class="wpd-wizard-note">
                                    <h3>
                                        <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/warning.png")); ?>"/> <?php esc_html_e("Custom wpDiscuz template files are detected!", "wpdiscuz"); ?>
                                    </h3>
                                    <p>
                            ...
                            if (intval(get_option(self::OPTION_SLUG_WIZARD_SHOW_ADDONS_MSG)) && !isset($_GET['wpd_addon_fix'])) {
                                ...
                                <div class="wpd-wizard-note">
                                    <h3>
                                        <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/warning.png")); ?>"/> <?php esc_html_e("All wpDiscuz Addons are Deactivated!", "wpdiscuz"); ?>
                                    </h3>
                                    <p>
                                        <span class="dashicons dashicons-welcome-comments"></span>
                                        <strong><?php esc_html_e("Information: ", "wpdiscuz") ?></strong>
                            ...
                            if (class_exists("Jetpack") && Jetpack::is_module_active("comments")) {
                                ...
                                <div class="wpd-wizard-note">
                                    <h3>
                                        <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/warning.png")); ?>"/> <?php esc_html_e("Jetpack comments is active, please deactivate!", "wpdiscuz"); ?>
                                    </h3>
                                    <p>
                                        <span class="dashicons dashicons-welcome-comments"></span>
                            ...
                            if ($notice) {
                                ...
                                <div class="wpd-wizard-help">
                                    <div style="width: 50%; padding: 20px; box-sizing: border-box;">
                                        <h3>
                                            <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/solved.png")); ?>"/> <?php esc_html_e("I can't resolve the problems!", "wpdiscuz"); ?>
                                        </h3>
                                    ...
                                    <div style="width: 50%; padding: 20px; box-sizing: border-box;">
                                        <h3>
                                            <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/cancel.png")); ?>"/> <?php esc_html_e("I want to downgrade to previous 5.x version!", "wpdiscuz"); ?>
                                        </h3>
                            ...
                            <div id="wpd_comment_layouts" style="width: 80%; margin: 15px auto 0 auto">
                                <div class="wpd-box-layout">
                                    <a href="#img1"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/layout-1s.png")); ?>"
                                                class="wpd-com-layout-1"/></a>
                                    <a href="#_" class="wpd-lightbox" id="img1"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/layout-1.png")); ?>"/></a>
                                ...
                                <div class="wpd-box-layout">
                                    <a href="#img2"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/layout-2s.png")); ?>"
                                                class="wpd-com-layout-2"/></a>
                                    <a href="#_" class="wpd-lightbox" id="img2"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/layout-2.png")); ?>"/></a>
                                ...
                                <div class="wpd-box-layout">
                                    <a href="#img3"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/layout-3s.png")); ?>"
                                                class="wpd-com-layout-3"/></a>
                                    <a href="#_" class="wpd-lightbox" id="img3"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/layout-3.png")); ?>"/></a>
                            ...
                            <div class="wpd-wizard-opt wpd-wizard-section">
                                <img class="wpd-opt-img"
                                     src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/box-bubble.png")); ?>"
                            ...
                            <div id="wpd_comment_layouts" style="width: 60%; margin: 15px auto 0 auto;">
                                <div class="wpd-box-layout">
                                    <a href="#img11"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/bubble-location-side.png")); ?>"
                                                class="wpd-com-layout-1"/></a>
                                    <a href="#_" class="wpd-lightbox" id="img11"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/bubble-location-side.png")); ?>"/></a>
                                ...
                                <div class="wpd-box-layout">
                                    <a href="#img22"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/bubble-location-left.png")); ?>"
                                                class="wpd-com-layout-2"/></a>
                                    <a href="#_" class="wpd-lightbox" id="img22"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/bubble-location-left.png")); ?>"/></a>
                                ...
                                <div class="wpd-box-layout">
                                    <a href="#img33"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/bubble-location-right.png")); ?>"
                                                class="wpd-com-layout-3"/></a>
                                    <a href="#_" class="wpd-lightbox" id="img33"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/bubble-location-right.png")); ?>"/></a>
                            ...
                            <div class="wpd-wizard-section" style="border-bottom: 2px solid #eee;">
                                ...
                                <img class="wpd-opt-img"
                                     src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/box-feedback.png")); ?>"
                                ...
                                <div class="wpd-zoom-image" style="width: 60%; margin: 0px auto;">
                                    <a href="#img_inline"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/inline-feedback-toolbar-button.png")); ?>"
                                                style="margin-top: 15px; margin-left: 5px; width: 100%;"/></a>
                                    <a href="#_" class="wpd-lightbox" id="img_inline"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/inline-feedback-toolbar-button-vertical.png")); ?>"/></a>
                                </div>
                            </div>
                            ...
                            <div class="wpd-wizard-section" style="border-bottom: 2px solid #eee;">
                                <img class="wpd-news-icon"
                                     src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/rating.png")); ?>"
                                ...
                                <div class="wpd-zoom-image" style="width: 70%; margin: 10px auto;">
                                    <a href="#img55"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/rating-vs.png")); ?>"
                                                style="width: 100%;"/></a>
                                    <a href="#_" class="wpd-lightbox" id="img55"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/news/rating-vs-v.png")); ?>"/></a>
                                </div>
                            </div>
                    ...
                    foreach ($settings["core"] as $tab_key => $setting) {
                        ...
                        <div class="wpd-box">
                            <div class="wpd-box-info wpd-<?php echo esc_attr($setting["status"]); ?>">
                                <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/" . $setting["status"] . ".png")); ?>"/>
                            </div>
                            <div class="wpd-box-head">
                                <a href="<?php echo esc_url_raw(admin_url("admin.php?page=" . WpdiscuzCore::PAGE_SETTINGS . "&wpd_tab=" . $tab_key)); ?>"
                                   title="<?php esc_attr_e("Open Settings", "wpdiscuz") ?>">
                                    <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/" . $setting["icon"])); ?>"
                                ...
                                <div class="wpd-box-arrow">
                                    <a href="<?php echo esc_url_raw(admin_url("admin.php?page=" . WpdiscuzCore::PAGE_SETTINGS . "&&wpd_tab=" . $tab_key)); ?>"
                                       title="<?php esc_attr_e("Open Settings", "wpdiscuz") ?>"><img
                                                src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/arrow-right.png")); ?>"/></a>
                                </div>
                            </div>
                        </div>
                        <!-- Settings end -->
                    ...
                    <div class="wpd-box-wrap wpd-box-addons wpd-settings-home">
                        <?php foreach ($settings["addons"] as $addon_key => $addon) { ?>
                            ...
                            <div class="wpd-box">
                                <div class="wpd-body">
                                    <div class="wpd-icon">
                                        <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/addon.png")); ?>"
                                    ...
                                    <div class="wpd-more">
                                        <img src="<?php echo esc_url_raw(rct_plugins_url(WPDISCUZ_DIR_NAME . "/assets/img/dashboard/dots.png")); ?>"
                ...
                <div id="wpd-settings-tab" class="wpd-box-wrap wpd-settings-tab_<?php echo esc_attr($tab); ?>"
                    ...
                    <div class="wpd-setbar">
                        <ul class="wpd-box wpd-menu-group">
                            ...
                            foreach ($settings["core"] as $tab_key => $setting) {
                                ?>
                                <li<?php if ($tab === $tab_key) {
                                    echo " class='wpd-active'";
                                   } ?>><a
